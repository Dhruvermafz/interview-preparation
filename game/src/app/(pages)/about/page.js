  ...
  return (
    <>
      ...
      <Flex padding={"0% 10%"} textAlign={"justify"}>
        <Text>
          Whether you're a numbers enthusiast or not, this game is designed to
          captivate and entertain you. Get ready to embark on an addictive
          ...
          your score, there's always an element of chance that adds excitement
          and unpredictability to the game. And here's a challenge for the
          skilled players: if you manage to beat the game, why not aim for a
          smaller score? That means finishing with fewer moves, truly showcasing
          your mastery of the game. Join the millions of players worldwide who
          have fallen in love with 2048. Experience the joy of strategic
          thinking, quick decision-making, and a dash of luck. Are you ready to
          take on the challenge and unlock the magic of 2048? Start playing now
          and see how far you can slide and merge your way to victory!
        </Text>
      </Flex>
