...
favIcon.setAttribute(
  "href",
  "https://github.com/Dhruvermafz/frontend-mini-challenges/raw/main/shared/assets/logo.png"
);
...
// Add title
const challengeLink = window.location.pathname
  .split("/challenges/")[1]
  .slice(0, -1);
const challenge = jsChallenges.find(
  (challenge) => challenge.link === challengeLink
);
