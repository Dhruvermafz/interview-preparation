...
function Visuals() {
  ...
  else if (myState.algorithm === "heap") speed *= 5;
    ...
    <div className="flex-1 p-1 md:p-5 flex items-center justify-start flex-col bg-[#EEEEEE] md:border-2 border-black">
      <div className="w-full flex items-center justify-center relative md:border-t-2 md:border-l-2 md:border-r-2 border-black">
        {myState.algorithm === "quick" && (
          <div className="py-[2px] px-[5px] absolute left-0 top-0 border border-gray-400 flex items-center font-medium text-sm ">
            <div className=" h-1 w-5 bg-[#222831] mr-1"></div> Pivot elements
          </div>
        )}
        {
          <div
            className="flex items-end justify-start h-[340px] mb-[40px] border-b border-black relative "
      ...
      <div className="md:-m-5">
        <button
          id="change-btn"
          className="mx-5 my-2 px-2 rounded-md border border-black"
          style={{ backgroundColor: color }}
          onClick={changeValues}
        >
          {" "}
          <MdOutlineChangeCircle className="inline my-1" />
          change values
        </button>
        <button
          id="play-btn"
        ...
        >
          {" "}
          <AiFillPlayCircle className="inline my-1" /> play
        </button>
        <button
          id="reload-btn"
          className="mx-5 my-2 px-2 rounded-md border border-black"
        ...
        >
          {" "}
          <AiOutlineReload className="inline my-1" /> Reload/Stop
        </button>
      </div>
